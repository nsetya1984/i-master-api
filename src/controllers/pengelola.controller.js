...
module.exports = {
  ...
  create: (req, res) => {
    ...
    db.Pengelola.insert(req.body, result => {
  ...
  getSome: (req, res) => {
    ...
    db.Pengelola.selectSome(condition,sort,limit, data => {
      res.json(data)
    });
  ...
  createNew: (req, res) => {
    db.Pengelola.insertOne(req.body.vals, result => {
      res.json({ id: result.insertId })
    })
  },
  getById: (req, res) => {
    console.log("==getById==");
    db.Pengelola.selectOne(req.params.id, data => {
      res.json(data)
    })
  },
  updateById: (req, res) => {
     db.Pengelola.updateOne(req.body, req.body.id, result => {
  ...
  deleteSome: (req, res) => {
    ...
    db.Pengelola.deleteSome(condition, data => {
      res.json(data)
    })
  },
  
  deleteById: (req, res) => {
    db.Pengelola.deleteOne(req.params.id, data => {
      res.json(data)
    })
  }
}
