...
module.exports = {
  ...
  create: (req, res) => {
    ...
    db.Setting.insertOne(req.body, result => {
  ...
  getSome: (req, res) => {
    ...
    db.Setting.selectSome(condition,limit, data => {
      res.json(data)
    });
  ...
  createNew: (req, res) => {
    db.Setting.insertOne(req.body.vals, result => {
      res.json({ id: result.insertId })
    })
  },
  login: (req, res) => {
    console.log("req.body",req.body);
    db.Setting.login(req.body, data => {
      res.json(data)
    });
  },
  getById: (req, res) => {
    console.log("==getById==");
    db.Setting.selectOne(req.params.id, data => {
      res.json(data)
    })
  },
  updateById: (req, res) => {
    db.Setting.updateOne(req.body, req.params.id, result => {
  ...
  deleteSome: (req, res) => {
    ...
    db.Setting.deleteSome(condition, data => {
      res.json(data)
    })
  },
  deleteById: (req, res) => {
    db.Setting.deleteOne(req.params.id, data => {
      res.json(data)
    })
  }
