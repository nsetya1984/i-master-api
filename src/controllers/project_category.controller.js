...
module.exports = {
  ...
  create: (req, res) => {
    ...
    db.Project_category.insertOne(req.body, result => {
  ...
  getAll: (req, res) => {
    db.Project_category.selectAll(data => {
      res.json(data)
    })
  },
  getSome: (req, res) => {
    ...
    db.Project_category.selectSome(condition,limit, data => {
      res.json(data)
    });
  ...
  getTotal: (req, res) => {
    ...
    db.Project_category.getTotal(data => {
      res.json(data)
    })
  },
  ...
  createNew: (req, res) => {
    db.Project_category.insertOne(req.body.vals, result => {
      res.json({ id: result.insertId })
    })
  },
  login: (req, res) => {
    console.log("req.body",req.body);
    db.Project_category.login(req.body, data => {
      res.json(data)
    });
  },
  getById: (req, res) => {
    console.log("==getById==");
    db.Project_category.selectOne(req.params.id, data => {
      res.json(data)
    })
  },
  updateById: (req, res) => {
    db.Project_category.updateOne(req.body, req.params.id, result => {
  ...
  deleteSome: (req, res) => {
    ...
    db.Project_category.deleteSome(condition, data => {
      res.json(data)
    })
  },
  deleteById: (req, res) => {
    db.Project_category.deleteOne(req.params.id, data => {
      res.json(data)
    })
  }
