...
module.exports = {
  ...
  create: (req, res) => {
    ...
    db.Problem_category.insertOne(req.body, result => {
  ...
  getAll: (req, res) => {
    db.Problem_category.selectAll(data => {
      res.json(data)
    })
  },
  getSome: (req, res) => {
    ...
    db.Problem_category.selectSome(condition,limit, data => {
      res.json(data)
    });
  ...
  getTotal: (req, res) => {
    ...
    db.Problem_category.getTotal(data => {
      res.json(data)
    })
  },
  ...
  createNew: (req, res) => {
    db.Problem_category.insertOne(req.body.vals, result => {
      res.json({ id: result.insertId })
    })
  },
  login: (req, res) => {
    console.log("req.body",req.body);
    db.Problem_category.login(req.body, data => {
      res.json(data)
    });
  },
  getById: (req, res) => {
    console.log("==getById==");
    db.Problem_category.selectOne(req.params.id, data => {
      res.json(data)
    })
  },
  updateById: (req, res) => {
    db.Problem_category.updateOne(req.body, req.params.id, result => {
  ...
  deleteSome: (req, res) => {
    ...
    db.Problem_category.deleteSome(condition, data => {
      res.json(data)
    })
  },
  deleteById: (req, res) => {
    db.Problem_category.deleteOne(req.params.id, data => {
      res.json(data)
    })
  }
