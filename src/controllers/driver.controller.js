...
module.exports = {
  ...
  create: (req, res) => {
    ...
    db.Driver.insertOne(req.body, result => {
  ...
  getSome: (req, res) => {
    ...
    db.Driver.selectSome(condition,limit, data => {
      res.json(data)
    });
  ...
  createNew: (req, res) => {
    db.Driver.insertOne(req.body.vals, result => {
      res.json({ id: result.insertId })
    })
  },
  getById: (req, res) => {
    console.log("==getById==");
    db.Driver.selectOne(req.params.id, data => {
      res.json(data)
    })
  },
  updateById: (req, res) => {
    db.Driver.updateOne(req.body, req.params.id, result => {
  ...
  deleteSome: (req, res) => {
    ...
    db.Driver.deleteSome(condition, data => {
      res.json(data)
    })
  },
  deleteById: (req, res) => {
    db.Driver.deleteOne(req.params.id, data => {
      res.json(data)
    })
  }
}
