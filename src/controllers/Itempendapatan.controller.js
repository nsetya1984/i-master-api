...
module.exports = {
  ...
  create: (req, res) => {
    ...
    db.Itempendapatan.insert(req.body, result => {
  ...
  getAll: (req, res) => {
    db.Itempendapatan.selectAll(data => {
      res.json(data)
    })
  },
  getSome: (req, res) => {
    ...
    db.Itempendapatan.selectSome(condition,limit,sort, data => {
      res.json(data)
    });
  ...
  getTotal: (req, res) => {
    ...
    db.Itempendapatan.getTotal(data => {
      res.json(data)
    })
  },
  ...
  createNew: (req, res) => {
    db.Itempendapatan.insertOne(req.body.vals, result => {
      res.json({ id: result.insertId })
    })
  },
  getById: (req, res) => {
    console.log("==getById==");
    db.Itempendapatan.selectOne(req.params.id, data => {
      res.json(data)
    })
  },
  updateById: (req, res) => {
    //req.body.registration_expiry_date = new Date(req.body.registration_expiry_date).toISOString().slice(0, 10);
    db.Itempendapatan.updateOne(req.body, req.body.id, result => {
  ...
  deleteSome: (req, res) => {
    ...
    db.Itempendapatan.deleteSome(condition, data => {
      res.json(data)
    })
  },
  
  deleteById: (req, res) => {
    db.Itempendapatan.deleteOne(req.params.id, data => {
      res.json(data)
    })
  }
}
